...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2013 at 11:44 PM
...
CREATE TABLE IF NOT EXISTS `baskets` (
  `baskets_id` int(11) NOT NULL AUTO_INCREMENT,
  `baskets_date_creation` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `baskets_date_expiration` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `baskets_url` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `baskets_private` tinyint(1) NOT NULL DEFAULT '0',
  `baskets_password` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`baskets_id`),
  KEY `baskets_url` (`baskets_url`)
...
(1, 'La tribu indienne', 'Indian horde', 'Exposition sur le peuple indien', 'Indian nation expositiond', 1),
...
CREATE TABLE IF NOT EXISTS `expositions_objets` (
  `eo_expositions_id` int(11) NOT NULL,
  `eo_objets_id` int(11) NOT NULL,
  PRIMARY KEY (`eo_expositions_id`,`eo_objets_id`)
